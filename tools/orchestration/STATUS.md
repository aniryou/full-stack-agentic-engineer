...
| Integration | layer READMEs, root README, `CLAUDE.md` decisions log, Colab links (`tools/gen_colab_index.py`) | layer 05 done (branch `claude/gifted-johnson-9gjwzc-l05`, PR pending); others per their rows | after each layer's review; final pass at the end |
