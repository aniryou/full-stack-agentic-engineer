...
## Done (2026-09-26)
All five layers, the deep primers, the README readability pass, CURRICULUM.md/COMPUTE.md (PR #7) and the GitHub Pages site (PR #8) are on `main`. The WIP branch is retained for history only.
