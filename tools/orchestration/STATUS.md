...
| Integration | layer READMEs, root README, `CLAUDE.md` decisions log, Colab links (`tools/gen_colab_index.py`) | layer 01 done (branch `claude/gifted-johnson-9gjwzc-l01`); 02–05 pending | after each layer's review; final pass at the end |
