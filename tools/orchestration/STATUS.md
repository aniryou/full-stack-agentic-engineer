...
| 02 cuda-and-nccl | `02-cuda-nccl-runtime/cuda-and-nccl/` (PRIMER, `cuda-nccl-core`, `cuda-nccl-lab`) | PRIMER+core built (111 tests, 5/5 nbs); lab building | lab report → review workflow for the whole layer |
