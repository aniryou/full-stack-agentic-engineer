...
| 04 serving-engine | `04-inference-engine/serving-engine/` (PRIMER, `mini-engine-core`, `vllm-serving-lab`) | PRIMER+core built (59 tests, 6/6 nbs), review running; lab building | lab report → lab review (check `../PRIMER.md` links from notebooks/ → should be `../../PRIMER.md`) |
