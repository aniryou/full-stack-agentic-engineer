...
Per-topic fact sheets written by the research agents: `$SP/facts-rl-and-thinking-models.md`, `$SP/facts-mixture-of-experts.md`, `$SP/facts-quantization.md`, `$SP/facts-sandboxed-execution.md`.
