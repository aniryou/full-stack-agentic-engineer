...
- The three kernel topics next door: [`kv-cache`](../kv-cache/kv-cache-primer.md),
  [`paged-attention`](../paged-attention/paged-attention-primer.md) (block tables, copy-on-write),
