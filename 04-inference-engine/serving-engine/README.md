...
| beside | layer 02's cuda-and-nccl primer §4–5 (`02-cuda-nccl-runtime/cuda-and-nccl/`) and layer 03's gpu-scheduling topic (`03-kubernetes-gpu/gpu-scheduling/`) | CUDA Graphs and the all-reduces tensor parallelism runs on; how the engine's pod gets its GPUs |
