...
A learning path through the whole repo (`CURRICULUM.md`) and a guide to where to get GPUs and what they cost
(`COMPUTE.md`) are being added at the repo root.
