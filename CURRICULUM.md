...
- **Budget about 170 hours** end to end, about 95 of them in layers 01–05; shorter routes are in §3.3.
...
Total: about 170 hours. Steps 3–18 (layers 01–05, including the existing layer-04 topics) are about 95 hours,
of which the three T3 steps (12, 15, 18) are 8 and optional. "T0 + Docker" means a laptop with Docker for kind
