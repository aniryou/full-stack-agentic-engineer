...
and 04. Prices and GPU obtainability: `COMPUTE.md` at the repo root. Where this sits in the whole
course: `CURRICULUM.md` at the repo root.

## Builds on, and leads to

* Layer 01 — [`roofline-and-fabric/PRIMER.md`](../../01-hardware-gpu-fabric/roofline-and-fabric/PRIMER.md) §5 (fabric
  bandwidth: why topology matters), §6 (cold-start arithmetic), §7 (checkpoint intervals), §10 (GPU families and
  obtainability); [`gpu-deployment-primer.md`](../../01-hardware-gpu-fabric/gpu-deployment/gpu-deployment-primer.md)
...
* Layer 05 — `05-orchestrator/serving-orchestration/PRIMER.md` §4 (autoscaling replicas and
  LeaderWorkerSet groups on queue and SLO signals; cold-start anatomy), §5 (prefill/decode
  disaggregation).
