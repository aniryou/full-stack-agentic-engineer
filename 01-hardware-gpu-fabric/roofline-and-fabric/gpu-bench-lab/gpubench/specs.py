...
GPUS = [
    ...
    GpuSpec("l4", "NVIDIA L4", "ada", "8.9", 24, "GDDR6", 300,
            {"float32": 30.3, "tf32": 60.0, "float16": 121.0, "bfloat16": 121.0, "float8_e4m3fn": 242.5},
            72, "PCIe Gen4 x16", 0, (r"\bL4\b",), "GCP g2-*; Cloud Run GPU; datasheet quotes 2:4-sparse figures (FP8 485)"),
