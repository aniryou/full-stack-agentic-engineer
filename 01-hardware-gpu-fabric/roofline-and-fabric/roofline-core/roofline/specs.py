...
PRECISIONS = ("fp32", "tf32", "fp16", "bf16", "fp8", "fp4", "int8", "int4")
...
DEVICES: dict[str, Device] = {
    "t4": _d(name="NVIDIA T4", vendor="NVIDIA", arch="Turing", year=2018,
    ...
    "l4": _d(name="NVIDIA L4", vendor="NVIDIA", arch="Ada Lovelace", year=2023,
    ...
    "a100-40gb": _d(name="NVIDIA A100 SXM 40GB", vendor="NVIDIA", arch="Ampere", year=2020,
    ...
    "a100-80gb": _d(name="NVIDIA A100 SXM 80GB", vendor="NVIDIA", arch="Ampere", year=2020,
                    memory_gb=80, memory_tbs=2.039, l2_mb=40,
                    tflops={"fp32": 19.5, "tf32": 156, "fp16": 312, "bf16": 312, "int8": 624},
                    scaleup_gbs=600, scaleup_domain=8, host_link="PCIe Gen4 x16", tdp_w=400,
                    gcp="A2 ultra (a2-ultragpu-1g..8g)"),
    "h100-sxm": _d(name="NVIDIA H100 SXM", vendor="NVIDIA", arch="Hopper", year=2022,
    ...
    "h200": _d(name="NVIDIA H200 SXM", vendor="NVIDIA", arch="Hopper", year=2024,
               memory_gb=141, memory_tbs=4.8, memory_type="HBM3e", l2_mb=50,
               tflops={"fp32": 67, "tf32": 494.7, "fp16": 989.4, "bf16": 989.4,
                       "fp8": 1978.9, "int8": 1978.9},
               scaleup_gbs=900, scaleup_domain=8, host_link="PCIe Gen5 x16", tdp_w=700,
               gcp="A3 Ultra (RDMA)", notes="H100 compute, more and faster memory"),
    "b200": _d(name="NVIDIA B200 (HGX)", vendor="NVIDIA", arch="Blackwell", year=2025,
    ...
    "gb200": _d(name="NVIDIA GB200 (per GPU, NVL72)", vendor="NVIDIA", arch="Blackwell", year=2025,
    ...
    "gb300": _d(name="NVIDIA GB300 (per GPU, NVL72)", vendor="NVIDIA", arch="Blackwell Ultra",
    ...
    "rtx-pro-6000": _d(name="NVIDIA RTX PRO 6000 Blackwell Server", vendor="NVIDIA", arch="Blackwell",
    ...
    "mi300x": _d(name="AMD Instinct MI300X", vendor="AMD", arch="CDNA 3", year=2023,
    ...
    "mi325x": _d(name="AMD Instinct MI325X", vendor="AMD", arch="CDNA 3", year=2024,
    ...
    "mi355x": _d(name="AMD Instinct MI355X", vendor="AMD", arch="CDNA 4", year=2025,
    ...
    "tpu-v5e": _d(name="Google TPU v5e", vendor="Google", arch="TPU v5e", year=2023,
    ...
    "tpu-v6e": _d(name="Google TPU v6e (Trillium)", vendor="Google", arch="TPU v6e", year=2024,
    ...
    "tpu-v7": _d(name="Google TPU7x (Ironwood)", vendor="Google", arch="TPU v7", year=2026,
