...
#
# **Primer sections:** 2.1 (the single-agent loop), 3.1 (tool design: contracts, side effects, errors).
#
...
# 3. design a tool contract, a self-correcting model policy and a tool wrapper you could sketch on a whiteboard.
