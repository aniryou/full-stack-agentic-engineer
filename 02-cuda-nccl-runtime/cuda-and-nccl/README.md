...
|---|---|---|
| **T0** | laptop, Colab CPU, CI ($0) | all of `cuda-nccl-core`; in the lab, Numba kernels in the CUDA simulator (`NUMBA_ENABLE_CUDASIM=1`), collectives over gloo, and parsing sample nccl-tests, nvidia-smi and DCGM output |
